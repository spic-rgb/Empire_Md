  ...
  if (m.message) {
    ...
    if (m.msg) {
      ...
      if (m.quoted) {
        ...
        let quoted_quotedMention = m.quoted.msg && m.quoted.msg.contextInfo ? m.quoted.msg.contextInfo.participant : ''
        let quoted_tagMention = m.quoted.msg && m.quoted.msg.contextInfo ? m.quoted.msg.contextInfo.mentionedJid : []
        let quoted_mention = typeof(quoted_tagMention) == 'string' ? [quoted_tagMention] : quoted_tagMention
        ...
        Object.defineProperty(m.quoted, 'getbuff', {
          get: async function() {
